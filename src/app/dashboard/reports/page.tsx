...
export default function ReportsPage() {
  ...
  const { data: cashInsData, isLoading: loadingCashIns } = useGetCashInsQuery();
  const { data: cashOutsData, isLoading: loadingCashOuts } = useGetCashOutsQuery();

  const projects = projectsData?.projects || [];
  const allCashIns = cashInsData?.cashIns || [];
  const allCashOuts = cashOutsData?.cashOuts || [];
