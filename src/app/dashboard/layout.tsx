      ...
      <aside className="hidden lg:flex flex-col w-64 border-r border-slate-800/60 bg-slate-950/80 backdrop-blur-2xl shrink-0 relative z-20 shadow-[4px_0_24px_rgba(0,0,0,0.2)]">
        ...
        <div className="p-4 bg-gradient-to-t from-slate-950/80 to-transparent pt-6 border-t border-slate-800/40">
          <div className="flex items-center gap-3 mb-3">
            <div className="h-9 w-9 bg-slate-800 border border-slate-700 rounded-full flex items-center justify-center text-slate-300 text-xs font-bold uppercase overflow-hidden">
              {user.profileImage ? (
        ...
        <div className="fixed inset-0 z-50 flex lg:hidden bg-slate-950/80 backdrop-blur-sm transition-opacity">
          <div className="w-64 bg-slate-900 border-r border-slate-800 flex flex-col h-full animate-in slide-in-from-left duration-250">
            ...
            <div className="p-4 border-t border-slate-800 bg-slate-950/40">
              <div className="flex items-center gap-3 mb-3">
                <div className="h-9 w-9 bg-slate-800 rounded-full flex items-center justify-center text-slate-300 text-xs font-bold uppercase overflow-hidden">
                  {user.profileImage ? (
                    <img src={user.profileImage} alt={user.fullName} className="h-full w-full object-cover" />
                  ) : (
                    user.fullName.slice(0, 2)
