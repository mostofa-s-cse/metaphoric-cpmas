...
import { ArrowLeft, ArrowRight, Calendar, Compass, DollarSign, ShieldAlert } from 'lucide-react';
...
export default async function ProjectDetailPage({ params }: Props) {
  ...
  const project = await prisma.websitePortfolio.findUnique({
    where: { id },
  });
  ...
  // Fetch adjacent projects for next/prev links
  const otherProjects = await prisma.websitePortfolio.findMany({
    where: {
      isActive: true,
      id: { not: id }
    },
