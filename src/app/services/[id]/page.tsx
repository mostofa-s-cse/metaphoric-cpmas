...
export default async function ServiceDetailPage({ params }: Props) {
  ...
  const service = await prisma.websiteService.findUnique({
    where: { id },
  });
  ...
  // Get other services for the sidebar/navigation list
  const otherServices = await prisma.websiteService.findMany({
    where: {
      isActive: true,
      id: { not: id }
    },
