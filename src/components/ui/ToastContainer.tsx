...
/**
 * CPMAS — Global Toast Notification System
 * Reads from the Redux UI slice and renders animated toasts.
 */
...
function ToastItem({ toast }: { toast: Toast }) {
  ...
  return (
    <div
      className={`flex items-start gap-3 px-4 py-3 rounded-xl shadow-2xl border text-sm font-medium animate-in slide-in-from-right duration-300 backdrop-blur-sm max-w-sm ${STYLES[toast.variant]}`}
    >
