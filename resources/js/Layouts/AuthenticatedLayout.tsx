...
const navItems: NavItem[] = [
  ...
  { name: 'Employee',          href: '/dashboard/employees',   routeName: 'dashboard.employees', icon: Users2,          roles: ['SUPER_ADMIN', 'ADMIN', 'ACCOUNTANT', 'PROJECT_MANAGER', 'DATA_ENTRY_OPERATOR'] },
